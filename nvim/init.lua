...
local on_attach = function(client, bufnr)
  ...
  nmap('<leader>ds', require('symbols-outline').toggle_outline, '[D]ocument [S]ymbols')
...
vim.keymap.set({ 'n', 'v' }, '<leader>mir', ':CellularAutomaton make_it_rain<CR>', { silent = true })
vim.keymap.set({ 'n', 'v' }, '<leader>gol', ':CellularAutomaton game_of_life<CR>', { silent = true })
